...
abstract class EventGridLayout extends AbstractElement
{
    ...
    protected function internalTransformToItem(ElementContextInterface $data): BrizyComponent
    {
        ...
        $elementContext = $data->instanceWithMBSection(
            $data->getThemeContext()->getMbHeadSection()
        ); // the foot should be already cached.. so no nee to build the right context
        ...
        $elementContext = $data->instanceWithMBSection(
            $data->getThemeContext()->getMbFooterSection()
        ); // the foot should be already cached.. so no nee to build the right context
