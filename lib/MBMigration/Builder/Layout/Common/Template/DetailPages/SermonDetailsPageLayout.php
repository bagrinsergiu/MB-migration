...
class SermonDetailsPageLayout extends DetailsPage
{
    public function setStyleDetailPage(array $sectionPalette): BrizyComponent
    {
        ...
        $sectionPalette['btn-bg'] = $this->additionalOptions["bg-color"];
        ...
        $wrapperItemTitle = [
            'bgColorHex' => $this->additionalOptions["bg-color"] ?? $this->colorPalettes['subpalette1']['bg-accent'] ?? $sectionPalette['bg-accent'] ?? $sectionPalette['btn-bg'] ?? $basicButtonStyleNormal['background-color'],
            'bgColorPalette' => '',
            'bgColorOpacity' => 1,
        ];
