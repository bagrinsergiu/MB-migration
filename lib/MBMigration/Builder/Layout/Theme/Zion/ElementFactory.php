...
use MBMigration\Builder\Layout\Theme\Zion\Elements\Events\EventLayoutElement;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Footer;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Forms\Form;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Forms\LeftForm;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Forms\RightForm;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Gallery\GalleryLayoutElement;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Groups\SmallGroupsListElement;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Head;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Prayer\PrayerFormElement;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Sermons\MediaLayoutElement;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Text\AccordionLayoutElement;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Text\FullMediaElement;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Text\FullText;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Text\GridLayoutElement;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Text\LeftMedia;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Text\LeftMediaCircle;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Text\ListLayoutElement;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Text\RightMedia;
use MBMigration\Builder\Layout\Theme\Zion\Elements\Text\TabsLayoutElement;
...
class ElementFactory extends AbstractThemeElementFactory
{
    public function getElement($name, BrowserPageInterface $browserPage) :ElementInterface
    {
        switch ($name) {
            ...
            case 'top-media-diamond':
                return new TopMediaDiamond($this->blockKit['blocks']['top-media-diamond'], $browserPage);
