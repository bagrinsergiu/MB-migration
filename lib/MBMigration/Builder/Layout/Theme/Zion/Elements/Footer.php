...
namespace MBMigration\Builder\Layout\Theme\Zion\Elements;
        ...
        try {
            try{
                $this->handleMbSectionItemsByOrder($data,
                    ...
                    $mbSection['items'],
                    0);
                $brizySection->getItemWithDepth(0, 0)->addVerticalContentAlign('center')->applyHorizontalAlignToCloneableItemsInColumn();
            } catch (\Exception $e) {
