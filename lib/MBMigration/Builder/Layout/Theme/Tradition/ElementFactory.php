...
use MBMigration\Builder\Layout\Theme\Tradition\Elements\Text\FullMedia;
...
use MBMigration\Builder\Layout\Theme\Tradition\Elements\Text\HorizontalTexts;
use MBMigration\Builder\Layout\Theme\Tradition\Elements\Text\ListLayoutElement;
use MBMigration\Builder\Layout\Theme\Tradition\Elements\Text\SideMedia;
use MBMigration\Builder\Layout\Theme\Tradition\Elements\Text\TabsLayoutElement;
use MBMigration\Builder\Layout\Theme\Tradition\Elements\Text\TwoOrThreeMedia;
...
class ElementFactory extends AbstractThemeElementFactory
{
    public function getElement($name, BrowserPageInterface $browserPage): ElementInterface
    {
        switch ($name) {
            ...
            case 'side-media':
                return new SideMedia($this->blockKit['blocks']['side-media'], $browserPage);
            case 'full-text':
                return new FullText($this->blockKit['blocks']['full-text'], $browserPage);
            case 'two-media':
                return new TwoOrThreeMedia($this->blockKit['blocks']['two-media'], $browserPage);
            case 'three-media':
                return new TwoOrThreeMedia($this->blockKit['blocks']['three-media'], $browserPage);
            case 'full-media':
