...
use MBMigration\Builder\Layout\Theme\Hope\Elements\Events\EventLayoutElement;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Footer;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Forms\Form;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Forms\LeftForm;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Forms\RightForm;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Gallery\GalleryLayoutElement;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Groups\SmallGroupsListElement;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Head;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Prayer\PrayerFormElement;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Sermons\MediaLayoutElement;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Text\AccordionLayoutElement;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Text\FullMediaElement;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Text\FullText;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Text\GridLayoutElement;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Text\LeftHeaderText;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Text\ListLayoutElement;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Text\PhotoCollageMediaElement;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Text\RightHeaderText;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Text\RightMediaElement;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Text\TabsLayoutElement;
use MBMigration\Builder\Layout\Theme\Hope\Elements\Text\TopSmallMediaElement;
...
class ElementFactory extends AbstractThemeElementFactory
{
    public function getElement($name, BrowserPageInterface $browserPage): ElementInterface
    {
        switch ($name) {
            ...
            case 'left-header':
                return new LeftHeaderText($this->blockKit['blocks']['left-header-text'], $browserPage);
            case 'right-header':
                return new RightHeaderText($this->blockKit['blocks']['right-header-text'], $browserPage);
            case 'full-media':
                return new FullMediaElement($this->blockKit['blocks']['full-media'], $browserPage);
            case 'top-media-small':
                return new TopSmallMediaElement($this->blockKit['blocks']['top-media-small'], $browserPage);
            case 'right-media':
                return new RightMediaElement($this->blockKit['blocks']['right-media'], $browserPage);
            case 'top-photo-collage':
                return new PhotoCollageMediaElement($this->blockKit['blocks']['top-photo-collage'], $browserPage);
            case 'full-text':
