...
var output = (() => {
  ...
  var import_fp_utilities, iconSelector, buttonSelector, getHref;
  var init_common = __esm({
    "../../../../../../../packages/elements/src/Text/utils/common/index.ts"() {
      ...
      init_object();
      init_string();
      iconSelector = `[data-socialicon],[style*="font-family: 'Mono Social Icons Font'"]`;
      buttonSelector = ".sites-button";
  ...
  var import_fp_utilities2, getColor, getBgColor, getText, getStyleModel;
