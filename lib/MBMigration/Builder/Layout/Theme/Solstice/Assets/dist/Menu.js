...
var output = (() => {
  ...
  var getMenuV = (data2) => {
    ...
    if (span) {
      ...
      const borderRadius = parseInt(styles2.borderRadius ?? 0);
      v2 = {
        ...v2,
  ...
  var getSubMenuV = (data2) => {
    ...
    let subMenuActiveColor = void 0;
    if (selectedLink) {
      const baseStyle2 = window.getComputedStyle(selectedLink);
      subMenuActiveColor = parseColorString(baseStyle2.color);
    }
    return {
      ...submenuTypography,
      ...bgColor && {
