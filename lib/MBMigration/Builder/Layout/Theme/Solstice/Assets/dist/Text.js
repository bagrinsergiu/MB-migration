...
var output = (() => {
  ...
  var extractUrlWithoutDomain = (url) => {
    const urlWithoutDomain = new URL(url).pathname;
    return urlWithoutDomain;
  };
  var getHref = (0, import_fp_utilities.mPipe)(
    readKey("href"),
    read,
    extractUrlWithoutDomain
  );
  var getTarget = (0, import_fp_utilities.mPipe)(readKey("target"), read);
  ...
  var getBorderWidth = (0, import_fp_utilities3.mPipe)(readKey("border-width"), read2);
  var getTransform = (0, import_fp_utilities3.mPipe)(readKey("text-transform"), read);
  var getText = pipe(readKey("text"), read, onNullish("BUTTON"));
  var getBgColorOpacity = (color, opacity) => {
  ...
  var extractInnerText = (node, stack, selector) => {
