...
var output = (() => {
  ...
  var import_fp_utilities, buttonSelector, getHref, normalizeOpacity;
  ...
  var import_fp_utilities2, getColor, getBgColor, getBorderWidth, getTransform, getText, getBgColorOpacity, getStyleModel;
  var init_getModel = __esm({
    "../../../../../../../packages/elements/src/Text/models/Button/utils/getModel.ts"() {
      ...
      getBorderWidth = (0, import_fp_utilities2.mPipe)(readKey("border-width"), read2);
