...
(() => {
  ...
  function getValidStyles(element) {
    ...
    const isSpecialElement = ["A", "U"].includes(element.tagName) || element.tagName === "SPAN" && !allowedTags.includes(parentTag);
    return isSpecialElement ? [...baseValidStyles, ...additionalStyles] : baseValidStyles;
  }
