...
(() => {
  ...
  var import_fp_utilities3, getColor2, getBgColor2, getBorderWidth, getBorderRadius, getTransform, getText, getBgColorOpacity, getStyleModel2, getModel4;
  ...
  function getButtonModel(node, urlMap) {
    ...
    buttons.forEach((button) => {
      ...
      const model = getModel4(button, urlMap);
