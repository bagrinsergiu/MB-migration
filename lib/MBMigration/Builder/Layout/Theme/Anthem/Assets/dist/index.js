...
(() => {
  ...
  var init_number = __esm({
    "../../../../../../../packages/utils/src/reader/number.ts"() {
      ...
      read = (v3) => {
        switch (typeof v3) {
          case "string": {
            const v_ = v3 !== "" ? Number(v3) : NaN;
            return isNaN(v_) ? void 0 : v_;
          }
          case "number":
            return isNaN(v3) ? void 0 : v3;
          default:
            return void 0;
        }
      };
  ...
  var init_prefixed = __esm({
    "../../../../../../../packages/utils/src/models/prefixed.ts"() {
      ...
      init_capitalize();
      prefixed = (v3, prefix) => {
        return Object.entries(v3).reduce((acc, [key, value]) => {
  ...
  var require_Nothing = __commonJS({
    "../../../../../../../node_modules/fp-utilities/dist/Nothing.js"(exports) {
      ...
      var isNothing = function(v3) {
        return v3 === null || v3 === void 0;
      };
      ...
      function orElse() {
        ...
        return args.length === 1 ? function(v3) {
          return (0, exports.isNothing)(v3) ? args[0] : v3;
    ...
    "../../../../../../../node_modules/fp-utilities/dist/mPipe.js"(exports) {
      ...
      function mPipe5() {
        ...
        return function() {
          ...
          return args.every(Nothing_1.isT) ? (_a2 = fns.reduce(function(v3, fn) {
            return (0, Nothing_1.isT)(v3) ? fn(v3) : void 0;
          }, h.apply(void 0, args))) !== null && _a2 !== void 0 ? _a2 : void 0 : void 0;
        };
      }
      exports.mPipe = mPipe5;
    }
  });
  ...
  var require_internals = __commonJS({
    "../../../../../../../node_modules/fp-utilities/dist/parsers/internals.js"(exports) {
      ...
      var Nothing_1 = require_Nothing();
      var isOptional = function(v3) {
        return v3.__type === "optional";
      };
      exports.isOptional = isOptional;
      var call = function(p, v3) {
        switch (p.__type) {
          case "optional":
          case "strict":
            return p.fn(v3);
      ...
      function _parse(parsers, object) {
        ...
        for (var p in parsers) {
          ...
          var v3 = (0, exports.call)(parsers[p], object);
          if (!(0, exports.isOptional)(parsers[p]) && (0, Nothing_1.isNothing)(v3)) {
            return void 0;
          }
          b[p] = v3;
        }
      ...
      function or() {
        ...
        return function() {
          ...
          for (var i = 0; i <= fns.length; i++) {
            var v3 = (_a = fns[i]) === null || _a === void 0 ? void 0 : _a.call.apply(_a, __spreadArray([fns], args, false));
            if (!(0, Nothing_1.isNothing)(v3)) {
              return v3;
            }
          }
        };
      ...
      read2 = (v3) => {
        switch (typeof v3) {
          case "string":
            return v3;
          case "number":
            return isNaN(v3) ? void 0 : v3.toString();
          default:
            return void 0;
        }
      };
  ...
  var import_fp_utilities, allowedTags, ignoreStyleExtracting, exceptExtractingStyle, defaultDesktopLineHeight, defaultTabletLineHeight, defaultMobileLineHeight, extractedAttributes, textAlign, iconSelector, buttonSelector, embedSelector, extractUrlWithoutDomain, getHref, getTarget, normalizeOpacity, encodeToString;
  ...
  // ../../../../../../../packages/elements/src/Text/models/Button/utils/getFontStyles.ts
  var import_fp_utilities3, filterNodes, getFontFamily, getFontSizeAndWeight, getFontStyles;
  var init_getFontStyles = __esm({
    "../../../../../../../packages/elements/src/Text/models/Button/utils/getFontStyles.ts"() {
      "use strict";
      ...
      getFontFamily = (defaultFamily, families, font) => {
        if (!font)
          return defaultFamily;
        const fontFamily = font.replace(/['"\,]/g, "").replace(/\s/g, "_").toLocaleLowerCase();
        if (!families[fontFamily]) {
          return defaultFamily;
        } else {
      ...
      getFontSizeAndWeight = (node) => {
        const targetNode = filterNodes(node)[0];
        const style = getNodeStyle(targetNode);
        const fontSize = (0, import_fp_utilities3.mPipe)(readKey("font-size"), read2, parseFloat)(style);
        const fontWeight = (0, import_fp_utilities3.mPipe)(readKey("font-weight"), read)(style);
      ...
      getFontStyles = ({
        ...
        const defaultFontFamily = (0, import_fp_utilities3.mPipe)(readKey("font-family"), read2)(style);
  ...
  function pipe(...[h, ...fns]) {
    return (...args) => fns.reduce((v3, fn) => fn(v3), h(...args));
  }
  var init_pipe = __esm({
    "../../../../../../../packages/utils/src/fp/pipe.ts"() {
      "use strict";
  ...
  var init_isNullish = __esm({
    "../../../../../../../packages/utils/src/isNullish.ts"() {
      "use strict";
      isNullish = (v3) => v3 === void 0 || v3 === null || typeof v3 === "number" && Number.isNaN(v3);
    }
  });

  // ../../../../../../../packages/utils/src/onNullish.ts
  function onNullish(...args) {
    return args.length === 1 ? (v3) => isNullish(v3) ? args[0] : v3 : isNullish(args[1]) ? args[0] : args[1];
  }
  ...
  var import_fp_utilities4, getColor2, getBgColor2, getBorderWidth, getBorderColor, getBorderRadius, getTransform, getText, getBgColorOpacity, getStyleModel2, getModel4;
  var init_getModel4 = __esm({
    "../../../../../../../packages/elements/src/Text/models/Button/utils/getModel.ts"() {
      ...
      init_getModel3();
      init_getFontStyles();
      import_fp_utilities4 = __toESM(require_dist());
      init_parseColorString();
      init_getNodeStyle();
      init_pipe();
      init_onNullish();
      ...
      init_string();
      init_uuid();
      getColor2 = (0, import_fp_utilities4.mPipe)(readKey("color"), read2, parseColorString);
      getBgColor2 = (0, import_fp_utilities4.mPipe)(
        readKey("background-color"),
        read2,
        parseColorString
      );
      getBorderWidth = (0, import_fp_utilities4.mPipe)(
        readKey("border-top-width"),
        read2,
        parseFloat
      );
      getBorderColor = (0, import_fp_utilities4.mPipe)(
        readKey("border-top-color"),
        read2,
        parseColorString
      );
      getBorderRadius = (0, import_fp_utilities4.mPipe)(
        readKey("border-top-left-radius"),
        read2,
        parseFloat
      );
      getTransform = (0, import_fp_utilities4.mPipe)(readKey("text-transform"), read2);
  ...
  var Stack, extractInnerText, copyClassList, flattenNode, btnSurroundedByText, getContainerStackWithNodes;
  var init_getContainerStackWithNodes = __esm({
    "../../../../../../../packages/elements/src/Text/utils/dom/getContainerStackWithNodes.ts"() {
      ...
      btnSurroundedByText = (node, buttons) => {
        const childNodes = Array.from(node.childNodes);
        let isSurrounded = false;
        childNodes.forEach((_node, idx) => {
          const isBtn = Array.from(buttons).some(
            (button) => button.isSameNode(_node)
          );
          if (!isBtn)
            return;
          ...
          const isNextNodeBtn = Array.from(buttons).some(
            (button) => button.isSameNode(nextNode)
          );
          if (isNextNodeBtn)
            return;
          isSurrounded = true;
