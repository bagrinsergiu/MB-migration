...
(() => {
  ...
  function removeEmptyNodes(node) {
    ...
    node.innerHTML = content.replace(/>\s{2,}/g, "> ");
    return node;
  }
  ...
  function copyColorStyleToTextNodes(element) {
    if (element.nodeType === Node.TEXT_NODE) {
      ...
      if (parentElement.tagName === "SPAN" || parentElement.tagName === "EM" || parentElement.tagName === "STRONG") {
        ...
        if (!parentStyle2?.fontWeight) {
          const fontWeight = parentElement.tagName === "STRONG" ? getComputedStyle(parentElement).fontWeight : parentOfParent.style.fontWeight;
          if (fontWeight) {
  ...
  function appendNodeStylesToDivsWithoutStyles(node) {
  ...
  var Stack, extractInnerText, copyClassList, flattenNode, removeWrongTags, replaceWrongTags, getContainerStackWithNodes;
    ...
    "../../../../../../../packages/elements/src/Text/utils/dom/getContainerStackWithNodes.ts"() {
      ...
      replaceWrongTags = (node) => {
        ...
        replaceElements.forEach((element) => {
          ...
          const newElement = isFont ? document.createElement("span") : document.createElement("div");
