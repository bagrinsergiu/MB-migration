...
(() => {
  ...
  var import_fp_utilities3, getColor2, getBgColor2, getBorderWidth, getBorderRadius, getTransform, getText, getPaddingTB, getPaddingRL, getBgColorOpacity, getStyleModel2, getModel4;
  var init_getModel4 = __esm({
    "../../../../../../../packages/elements/src/Text/models/Button/utils/getModel.ts"() {
      ...
      getPaddingTB = (0, import_fp_utilities3.mPipe)(readKey("padding-top"), read2, parseInt);
      getPaddingRL = (0, import_fp_utilities3.mPipe)(readKey("padding-left"), read2, parseInt);
