...
(() => {
  ...
  var import_fp_utilities4, getColor2, getBgColor2, getBorderWidth, getBorderRadius, getTransform, getText, getBgColorOpacity, getStyleModel2, getModel4;
  var init_getModel4 = __esm({
    "../../../../../../../packages/elements/src/Text/models/Button/utils/getModel.ts"() {
      ...
      getBorderWidth = (0, import_fp_utilities4.mPipe)(readKey("border-width"), read);
  ...
  var Stack, extractInnerText, copyClassList, flattenNode, getContainerStackWithNodes;
