...
class GridMediaLayout extends DynamicElement
{
    ...
    private function GridMediaLayout(array $sectionData)
    {
        ...
        $objBlock->item()->item(1)->item()->setting('paginationColorHex', $sectionData['style']['sermon']['pagination-normal'] ?? '#616161');
        ...
        $objBlock->item()->item(1)->item()->setting('activePaginationColorHex', $sectionData['style']['sermon']['pagination-active'] ?? "#1e1eb7" );
        ...
        $objBlock->item()->item(1)->item()->setting('hoverPaginationColorHex', $sectionData['style']['sermon']['pagination-normal'] ?? "#1e1eb7");
