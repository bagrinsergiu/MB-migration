...
(() => {
  ...
  var init_Menu = __esm({
    "src/Menu/index.ts"() {
      ...
      run2 = (_entry) => {
        ...
        const section = sectionSelector ? document.querySelector(sectionSelector) : void 0;
        const menuItem = itemSelector ? document.querySelector(itemSelector) : void 0;
        const subMenuItem = subItemSelector ? document.querySelector(subItemSelector) : void 0;
        if (!menuItem) {
          return {
  ...
  var import_fp_utilities, allowedTags, exceptExtractingStyle, extractedAttributes, textAlign, iconSelector, buttonSelector, embedSelector, extractUrlWithoutDomain, getHref, getTarget, normalizeOpacity;
