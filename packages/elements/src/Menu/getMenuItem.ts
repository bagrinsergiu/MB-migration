...
const getMenuItem = (entry: MenuItemEntry): Output => {
    const {itemSelector, itemBgSelector, itemPaddingSelector, hover, families, defaultFamily} = entry;
    ...
    const itemPaddingElement = document.querySelector(itemPaddingSelector.selector);
    ...
    const itemPadding = {item: itemPaddingElement, pseudoEl: itemPaddingSelector.pseudoEl};
