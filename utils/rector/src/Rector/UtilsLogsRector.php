...
class UtilsLogsRector extends \Rector\Rector\AbstractRector
{
    /**
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        $logMessage = $node->args[0]->value->value;
        $logType = $node->args[1]->value->value;

        // ["DEBUG", "INFO", "WARNING", "CRITICAL", "PROCESS", "ERROR", "SUCCESSFULLY", "ErrorDump"]
        $logMethod = '';
        switch ($logType) {
            case 0:
                $logMethod = 'debug';
