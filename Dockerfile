...
RUN apt-get update && \
    ...
    curl -LO https://dl.google.com/linux/deb/pool/main/g/google-chrome-stable/google-chrome-stable_143.0.7499.169-1_amd64.deb && \
    apt-get install --no-install-recommends -y ./google-chrome-stable_143.0.7499.169-1_amd64.deb && \
    rm google-chrome-stable_143.0.7499.169-1_amd64.deb && \
